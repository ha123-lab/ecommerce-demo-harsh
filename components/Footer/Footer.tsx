...
const Footer = () => {
  return (
          ...
          <div className={styles.FooterRow}>
            ...
            <div>
              <div className={styles.subscription}>
                   <input type="text" placeholder="Enter your email" className={styles.Message}/>
           ...
           <address>
            111 Bijoy sarani, Dhaka,  DH 1515, Bangladesh.
              ...
              <div className={styles.ContactLink}>
                 <a href="mailto:harshsharma8595@gmail.com">exclusive@gmail.com</a>
                
                <a href="tel:  +88015-88888-9999-456-7890">  +88015-88888-9999</a>
              </div>
            ...
            <div className={`${styles.FooterCol} ${styles.FooterCol3} ${styles.FooterTitle}`}>
            <h5 className={styles.FooterTitle} >
              Account
              </h5>
              <ul>
    ...
    <div className={styles.FooterSave}>Save $3 with App New User Only</div>
